...
export const WithPayment = styled.View``
export const WithoutPayment = styled.View``

export const Divider = styled.View<{ activate: boolean }>`
  margin-top: 5px;
  width: 58px;
  height: 2px;
  background-color: ${props => props.activate ? "#07B7F7" : "#656565"}
`
